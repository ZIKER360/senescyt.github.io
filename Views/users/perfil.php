        ...
        <div class="col">
            <div class="tab-content" id="myTabContent">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="usuario" name="usuario" placeholder="juanfernando" value="<?php echo $data['usuario']['usuario']; ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="celular" class="form-label">Número Celular:</label>
                                        <input type="text" class="form-control" id="celular" name="celular" placeholder="(xxx) xxx-xxxx" value="<?php echo $data['usuario']['celular']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row m-t-lg">
                                    <div class="col">
                                        <button type="submit" class="btn btn-outline-primary m-t-sm">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                    <form id="frmPass" autocomplete="off">
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-t-xxl">
                                    <div class="col-md-6">
                                        <label for="settingsCurrentPassword" class="form-label">Ingrese la contraseña actual:</label>
                                        <input type="password" id="clave_actual" name="clave_actual" class="form-control" placeholder="Contraseña actual">
                                    </div>
                                </div>
                                <div class="row m-t-xxl">
                                    <div class="col-md-6">
                                        <label for="settingsNewPassword" class="form-label">Ingrese la nueva contraseña:</label>
                                        <input type="password" id="clave_nueva" name="clave_nueva" class="form-control" placeholder="Nueva contraseña">
                                    </div>
                                </div>
                                <div class="row m-t-xxl">
                                    <div class="col-md-6">
                                        <label for="settingsConfirmPassword" class="form-label">Confirme la contraseña:</label>
                                        <input type="password" id="clave_confirmar" name="clave_confirmar" class="form-control" placeholder="Confirmar contraseña">
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col">
                                        <button type="submit" class="btn btn-outline-primary m-t-sm">Cambiar contraseña</button>
                                    </div>
                                </div>
                            </div>
                        </div>
