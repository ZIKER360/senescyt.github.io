                    ...
                    <div class="col-md-4">
                        <div class="card file-manager-group">
                            <div class="card-body d-flex align-items-center">
                                <i class="material-icons" style="color: #<?php echo $folder['color']; ?> ">folder</i>
                                <div class="file-manager-group-info flex-fill">
                                    <a href="#" id="<?php echo $folder['id']; ?>" class="file-manager-group-title folders"> <?php echo $folder['nombre']; ?> </a>
                                    <span class="file-manager-group-about"><?php echo $folder['fecha']; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="file-manager-recent-<?php echo $archivo['id']; ?>">
                                        <li><a class="dropdown-item share" id="<?php echo $archivo['id']; ?>" href="#">Compartir</a></li>
